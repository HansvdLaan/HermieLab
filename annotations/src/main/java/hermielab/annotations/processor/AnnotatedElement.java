package hermielab.annotations.processor;
...
public class AnnotatedElement implements Comparable{
    ...
    public int compareTo(Object o) {
        if(o instanceof AnnotatedElement) {
            ...
            throw new IllegalArgumentException("parameter should be instance of hermielab.annotations.processor.AnnotatedElement");
        }
    }
