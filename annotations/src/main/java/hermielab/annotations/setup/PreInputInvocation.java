...
/**
 * The annotation type {@code hermielab.annotations.setup.PreInputInvocation} type is used to
 * indicate which methods should be called before any input method of any input symbol
