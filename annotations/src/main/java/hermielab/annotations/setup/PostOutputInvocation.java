...
/**
 *
 * The annotation type {@code hermielab.annotations.setup.PostOutputInvocation} type is used to
 * indicate which methods should be called after any ouput method of any input symbol
