package hermielab.generator.component;
...
public class ComponentGenerator {
    ...
    private List<BiFunction<
            GeneratedSpecContainer, //the original hermielab.generator.settings
            Settings, //the preprocessed hermielab.generator.settings upon that point
            GeneratedSpecContainer> //the preprocessed hermielab.generator.settings after the transformation
            > transformations;
