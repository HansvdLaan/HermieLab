...
import hermielab.generator.settings.transformations.TransformationResult;
...
public class SettingsPreProcessor {
    ...
    private List<BiFunction<
            Settings, //the original hermielab.generator.settings
            Settings, //the preprocessed hermielab.generator.settings upon that point
            TransformationResult> //the preprocessed hermielab.generator.settings after the transformation
            > transformations;
