...
public final class WrapperGeneratorTests {
    ...
    public static void setUpProcessor() throws DocumentException {
        DummyPreProcessor processor = (DummyPreProcessor) javac().withProcessors(new DummyPreProcessor()).compile(
                JavaFileObjects.forResource("component/utils/GeneratorUtilsTestClass.java"),
                JavaFileObjects.forResource("component/utils/Importer.java")
    ...
    public static void setUpInputFunctionSettings() {
        ...
        data1.put("class","component.utils.GeneratorUtilsTestClass");
        ...
        data2.put("class","component.utils.GeneratorUtilsTestClass");
        ...
        data3.put("class","component.utils.GeneratorUtilsTestClass");
        ...
        data4.put("class","component.utils.GeneratorUtilsTestClass");
        ...
        data5.put("class","component.utils.GeneratorUtilsTestClass");
        data5.put("method","method5(component.utils.UserClass)");
