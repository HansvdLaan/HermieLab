...
import hermielab.core.checker.CheckerSettings;
import hermielab.core.checker.nfa.GUINFAChecker;
import hermielab.core.checker.nfa.SingleNFAChecker;
...
import hermielab.core.proxy.Proxy;
...
public abstract class LearningSetup<AO,CO> {
    ...
    public abstract Automaton executeExperiment();
